...
if(isset($_REQUEST['_search']) && $searchOn!='false' && $type=='battingStats')
{
	...
	if( $fld=='batting_id' || $fld=='score' || $fld=='four_count' || $fld=='six_count' || $fld=='out_status' || $fld=='player_id' || $fld=='overs_played' || $fld=='match_number' || $fld=='team_name' || $fld=='overs_bowled' || $fld=='wide_balls' || $fld=='no_balls' || $fld=='extra_runs' || $fld=='runs_conceived' || $fld=='catches_taken') 
	{
