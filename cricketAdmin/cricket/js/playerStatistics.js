jQuery("#statistics01").jqGrid({
	...
	datatype: "json",
	width:770,
	colNames:['Id', 'MindTree ID', 'Email', 'First Name', 'Last Name' , 'Sex' , 'Skill', 'Rating', 'Description', 'Base Price'],
	colModel:[
		...
		{name:'sexselect',index:'sexselect', formoptions:{label: 'Sex *'},width:55,align:"center", editable: true,editrules: { required: true, edithidden:true } ,edittype:"select",editoptions:{value:"1:Male;2:Female"}},
