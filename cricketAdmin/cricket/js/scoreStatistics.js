jQuery(document).ready(function()
{
	...
	jQuery("#scoreStatistics").jqGrid({
		...
		datatype: "json",
		width:770,
		colNames:['Id', 'First Name','Last Name','Team','Match Time', 'Four' , 'Six', 'Out', 'Bowls Played' ,'Score','Overs Bowled','Wide Balls','No Balls','Extra Runs','Runs Conceived','Catches Taken'],
		colModel:[
			...
			{name:'extra_runs',index:'extra_runs', align:"center",formoptions:{label: 'Extra Runs'}, sortable:true, hidden:false, editable: true},
