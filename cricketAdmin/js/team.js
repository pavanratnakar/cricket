...
{ 
	...
	jQuery("#team01").jqGrid({
		...
		datatype: "json",
		width:770,
		colNames:['Id', 'MindTree ID', 'Email', 'First Name', 'Last Name' , 'Gender' , 'Skill', 'Rating', 'Description', 'Base Price' , 'Sold Price' , 'Team', 'Increase'],
		colModel:[
			...
			{name:'sexselect',index:'sexselect', formoptions:{label: 'Gender *'}, align:"center", editable: true,hidden:false,editrules: { required: true, edithidden:true } ,edittype:"select",editoptions:{value:"1:Male;2:Female"}},
